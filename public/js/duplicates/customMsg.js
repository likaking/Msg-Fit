...
//Assign a location to each person
...
let cb;
 while( x > 0){
  ...
  ib= allLocations.shift()
  allLocations.push(ib)
...
let updateSec = setDtime;
  ...
  allLocations = locationBox.value.toString().replace(/(,(?!\w+))/g, " ").split(",");
